...
const Land = () => {
  ...
  const restaurants = [
    { id: 1, name: 'Pizza Paradise', cuisine: 'Italian', rating: 4.4, time: '30-40 min', image: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=400&h=300&fit=crop', offer: '50% off' },
    { id: 2, name: 'Burger Bliss', cuisine: 'American', rating: 4.2, time: '25-35 min', image: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&h=300&fit=crop', offer: 'Free delivery' },
    { id: 3, name: 'Sushi Station', cuisine: 'Japanese', rating: 4.6, time: '40-50 min', image: 'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=400&h=300&fit=crop', offer: '₹100 off' },
    { id: 4, name: 'Curry House', cuisine: 'Indian', rating: 4.5, time: '35-45 min', image: 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=400&h=300&fit=crop', offer: '40% off' },
  ]
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-4 py-2 rounded-lg font-semibold hover:shadow-lg transition-all flex items-center space-x-1">
              ...
              {restaurants.map((restaurant) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <button className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-2 rounded-lg font-semibold hover:shadow-lg transition-all flex items-center justify-center space-x-1">
                      <span>Order Now</span>
